...
export type { FooterBadge, FooterMeta, FooterBadgesRemoteConfig, GetRemoteFooterBadgesOptions, GetRemoteFooterMetaOptions, HandleFooterBadgesRevalidateOptions, FooterBadgesMarqueeProps, } from './types';
...
export { extractProjectFooterMeta } from './core/extract-project-footer-meta';
export { getRemoteFooterBadges } from './next/get-remote-footer-badges';
export { getRemoteFooterMeta } from './next/get-remote-footer-meta';
